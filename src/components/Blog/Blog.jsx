  ...
  const blogs = [
    {
      id: 1,
      img: Blog4,
      context: 'Почему не стоит покупать подержанные шины?',
    },
    { id: 2, img: Blog3, context: 'РАСШИРЕННАЯ ГАРАНТИЯ' },
    {
      id: 3,
      img: Blog2,
      context: 'Проверенные летние шины сезона 2019 для внедорожников',
    },
        ...
        <main>
          <div className='container'>
            <section className='blog mt-14 flex justify-center gap-6 mb-20'>
              ...
              >
                <img className='mb-6' src={BlogImg.src} alt='' />
                <div className='text-darkMain font-body max-w-[600px] flex flex-col gap-4'>
                  ...
                  <p className='2xl:text-lg xl:text-lg lg:text-lg md:text-md sm:text-sm text-sm text-justify'>
                    Автомобилисты, Вы уже видели? Кто это тут у нас? Новички
                    всегда подвергаются пристальному вниманию! Так и шины Boto –
                    уверенно ворвались на прилавки, да еще и с громкими
                    заявлениями, мол «Вы нас полюбите!».
                  </p>
                </div>
              </div>
